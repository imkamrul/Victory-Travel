    ...
    axios
      ...
      .then((res) => {
        if (res.data.deletedCount) {
          ...
          const updateMyBooking = myBooking.filter(
        ...
        <Row>
          ...
          <Row className="g-4">
            {myBooking?.map((booking) => (
              <Col xs={12} md={4} key={booking._id}>
                ...
                >
                  ...
                  <Modal.Body>Deleting this package. Are you sure?</Modal.Body>
                  <Modal.Footer>
