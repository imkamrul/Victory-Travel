                        ...
                        <Row className="g-4">
                            <Col xs={6} >
                                <div className="adventure-service">
                                    <p className="text-center "><i className="fas fa-dollar-sign fs-1 "></i></p>
                            ...
                            <Col xs={6}>
                                <div className="adventure-service">
                                    <p className="text-center "><i className="fas fa-user-shield fs-1 "></i></p>
                            ...
                            <Col xs={6}>
                                <div className="adventure-service">
                                    <p className="text-center "><i className="fas fa-route fs-1 "></i></p>
                            ...
                            <Col xs={6}>
                                <div className="adventure-service">
                                    <p className="text-center "><i className="fab fa-guilded fs-1 "></i></p>
